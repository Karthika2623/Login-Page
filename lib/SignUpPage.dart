...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void SignUp(String name, email, password, cPassword) async {
    try {
                      ...
                      onPressed: () {
                        ...
                        if (_formKey.currentState!.validate() &&
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: const Text('SignUp Successfully',style: TextStyle(fontSize: 18.0,color: Colors.white),
                            ),
